...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const [usersRes, clicksRes] = await Promise.all([getUsers(), getAllClicks()]);
    ...
    <div className="min-h-screen bg-white p-8">
      ...
      <header className="mb-8">
        ...
        <p className="text-[#DA9FA3] mt-2">
          Overview of User View History and Click Analytics
        </p>
      </header>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div className="bg-[#F0CCCE]/20 shadow rounded p-6 flex items-center gap-4 hover:scale-105 transition">
          ...
          <div>
            <h2 className="text-[#D2979B] font-medium mb-1">Daily Views</h2>
      ...
      {modalData && (
        <div className="fixed inset-0 bg-black/40 flex justify-center items-center z-50">
          <div className="bg-white p-6 rounded-xl shadow-xl w-[90%] md:w-[500px] relative">
            ...
            {modalType === "allUsers" && (
              <>
                <h2 className="text-2xl font-bold text-[#B87A7D] mb-4">All Registered Users</h2>
